    ...
    <div style={{ margin: "85px 0" }}>
      <div class="row">
        <div class="col-md-6">
          <h4 class="ml-4 mt-3 heading-color">
            ...
            &nbsp;
            <span class="heading-color">Create Mandates</span>
          </h4>
        </div>
        <div class="col-md-6">
      ...
      <div>
        <form role="form" method="POST">
          ...
          <input type="hidden" name="utilityCode" value="NACH00000000000361" />
...
export default InitiateMandateRequest;
