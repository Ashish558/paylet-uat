  ...
  return (
    <div style={{ margin: "85px 0" }}>
      <div class="row mt-5 pt-3">
        <div class="col-md-6">
          <h4 class="ml-4 mt-3 heading-color">
            ...
            &nbsp;
            <span class="heading-color">Search Mandate</span>
          </h4>
        </div>
        <div class="col-md-6">
      ...
      <div class="row sector2 mr-1 mb-4">
        <div class="col-md-6">
          <h5 class="mb-0">Search Mandate</h5>
      ...
      <Table
        ...
        tableData={tableData}
        tableName={`Search Mandate Details`}
        defaultSort={`date`}
      />
...
export default SearchMandateRequest;
