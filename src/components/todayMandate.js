  ...
  return (
    <div style={{ margin: "85px 0" }}>
      <div class="row">
        <div class="col-md-6">
          <h4 class="ml-4 mt-3 heading-color">
            ...
            &nbsp;
            <span class="heading-color">Today-Mandate</span>
          </h4>
        </div>
      </div>
      ...
      <div class="row sector2 mr-1">
        <div class="col-md-6">
          <h5 class="mb-0">Today-Mandate Details</h5>
      ...
      <Table
        ...
        tableData={tableData}
        tableName={`Today-Mandate Details`}
        defaultSort={`date`}
      />
